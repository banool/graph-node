...
pub const APTOS_KIND: &str = "aptos";
const BLOCK_HANDLER_KIND: &str = "block";
const RECEIPT_HANDLER_KIND: &str = "receipt";

/// Runtime representation of a data source.
// This is what people configure in their subgraph.yaml files.
#[derive(Clone, Debug)]
...
// TODO: We want ABIs too. Or is that necessary, maybe not? The txn stream just
// has JSON in it so the mapping only needs types generated from the ABI to make
// writing a mapping easier, whereas with Ethereum it's a bunch of bytes that
// has to be converted to JSON before being passed to the mapping (I assume).
#[derive(Clone, Debug)]
pub struct Mapping {
    pub api_version: semver::Version,
    pub language: String,
    pub entities: Vec<String>,
    // TODO: It'd be nice to call this a txn handler instead.
    pub block_handlers: Vec<MappingBlockHandler>,
    // TODO: Get rid of these, we want event handlers instead. We also want "call
    // handlers" like in the Ethereum data source.
    pub receipt_handlers: Vec<ReceiptHandler>,
